...
var DisplayP3ToLinearSRGB = function(color) {
  return color.convertSRGBToLinear().applyMatrix3(LINEAR_DISPLAY_P3_TO_LINEAR_SRGB);
};
var LinearSRGBToDisplayP3 = function(color) {
...
var satForAxes = function(axes, v0, v1, v2, extents) {
...
var checkIntersection = function(object, material, raycaster, ray, pA, pB, pC, point) {
  let intersect;
...
var checkGeometryIntersection = function(object, material, raycaster, ray, uv, uv1, normal, a, b, c) {
...
var WebGLBackground = function(renderer, cubemaps, cubeuvmaps, state, objects, alpha, premultipliedAlpha) {
...
var WebGLBindingStates = function(gl, extensions, attributes, capabilities) {
...
var absNumericalSort = function(a, b) {
  return Math.abs(b[1]) - Math.abs(a[1]);
};
var WebGLMorphtargets = function(gl, capabilities, textures) {
...
var allocTexUnits = function(textures, n) {
...
var setValueV1ui = function(gl, v) {
  const cache = this.cache;
  if (cache[0] === v)
    return;
...
var setValueV2ui = function(gl, v) {
  const cache = this.cache;
  if (v.x !== undefined) {
    if (cache[0] !== v.x || cache[1] !== v.y) {
...
var setValueV3ui = function(gl, v) {
  const cache = this.cache;
  if (v.x !== undefined) {
    if (cache[0] !== v.x || cache[1] !== v.y || cache[2] !== v.z) {
...
var setValueV4ui = function(gl, v) {
  const cache = this.cache;
  if (v.x !== undefined) {
    if (cache[0] !== v.x || cache[1] !== v.y || cache[2] !== v.z || cache[3] !== v.w) {
...
var setValueT1 = function(gl, v, textures) {
  const cache = this.cache;
...
var setValueT3D1 = function(gl, v, textures) {
  const cache = this.cache;
  const unit = textures.allocateTextureUnit();
  if (cache[0] !== unit) {
    gl.uniform1i(this.addr, unit);
...
var setValueT6 = function(gl, v, textures) {
  const cache = this.cache;
  const unit = textures.allocateTextureUnit();
  if (cache[0] !== unit) {
    gl.uniform1i(this.addr, unit);
...
var setValueT2DArray1 = function(gl, v, textures) {
  const cache = this.cache;
  const unit = textures.allocateTextureUnit();
  if (cache[0] !== unit) {
    gl.uniform1i(this.addr, unit);
...
var setValueV1fArray = function(gl, v) {
  gl.uniform1fv(this.addr, v);
};
var setValueV2fArray = function(gl, v) {
  const data = flatten(v, this.size, 2);
  gl.uniform2fv(this.addr, data);
};
var setValueV3fArray = function(gl, v) {
  const data = flatten(v, this.size, 3);
  gl.uniform3fv(this.addr, data);
};
var setValueV4fArray = function(gl, v) {
  const data = flatten(v, this.size, 4);
  gl.uniform4fv(this.addr, data);
};
var setValueM2Array = function(gl, v) {
  const data = flatten(v, this.size, 4);
  gl.uniformMatrix2fv(this.addr, false, data);
};
var setValueM3Array = function(gl, v) {
  const data = flatten(v, this.size, 9);
  gl.uniformMatrix3fv(this.addr, false, data);
};
var setValueM4Array = function(gl, v) {
  const data = flatten(v, this.size, 16);
  gl.uniformMatrix4fv(this.addr, false, data);
};
var setValueV1iArray = function(gl, v) {
  gl.uniform1iv(this.addr, v);
};
var setValueV2iArray = function(gl, v) {
  gl.uniform2iv(this.addr, v);
};
var setValueV3iArray = function(gl, v) {
  gl.uniform3iv(this.addr, v);
};
var setValueV4iArray = function(gl, v) {
  gl.uniform4iv(this.addr, v);
};
var setValueV1uiArray = function(gl, v) {
  gl.uniform1uiv(this.addr, v);
};
var setValueV2uiArray = function(gl, v) {
  gl.uniform2uiv(this.addr, v);
};
var setValueV3uiArray = function(gl, v) {
  gl.uniform3uiv(this.addr, v);
};
var setValueV4uiArray = function(gl, v) {
  gl.uniform4uiv(this.addr, v);
};
var setValueT1Array = function(gl, v, textures) {
  const cache = this.cache;
  const n = v.length;
...
var setValueT3DArray = function(gl, v, textures) {
  const cache = this.cache;
  const n = v.length;
  const units = allocTexUnits(textures, n);
  if (!arraysEqual(cache, units)) {
...
var setValueT6Array = function(gl, v, textures) {
  const cache = this.cache;
  const n = v.length;
  const units = allocTexUnits(textures, n);
  if (!arraysEqual(cache, units)) {
...
var setValueT2DArrayArray = function(gl, v, textures) {
  const cache = this.cache;
  const n = v.length;
  const units = allocTexUnits(textures, n);
  if (!arraysEqual(cache, units)) {
...
var WebGLPrograms = function(renderer, cubemaps, cubeuvmaps, extensions, capabilities, bindingStates, clipping) {
...
var reversePainterSortStable = function(a, b) {
  if (a.groupOrder !== b.groupOrder) {
    return a.groupOrder - b.groupOrder;
  } else if (a.renderOrder !== b.renderOrder) {
    return a.renderOrder - b.renderOrder;
...
var WebGLLights = function(extensions, capabilities) {
...
var WebGLRenderState = function(extensions, capabilities) {
...
var WebGLRenderStates = function(extensions, capabilities) {
...
var WebGLState = function(gl, extensions, capabilities) {
  const isWebGL2 = capabilities.isWebGL2;
...
var WebGLTextures = function(_gl, extensions, state, properties, capabilities, utils, info) {
  const isWebGL2 = capabilities.isWebGL2;
...
var WebGLUtils = function(gl, extensions, capabilities) {
  const isWebGL2 = capabilities.isWebGL2;
...
var testPoint = function(point, index, localThresholdSq, matrixWorld, raycaster, intersects, object) {
...
var animate = function() {
  ...
  sphereGeometry.rotation.y += 0.01;
  sphereGeometry.rotation.x += 0.000022;
};
var scene = new Scene;
...
var sphereGeometry = new Mesh(new SphereGeometry(5, 50, 50), new ShaderMaterial({
  vertexShader: `
     varying vec2 vUV;
     varying vec3 vNormal;
     void main(){
  ...
  fragmentShader: `
     ...
     vec3 atmosphere = vec3(0.4, 0.2, .6) * intensity;
      gl_FragColor = vec4(atmosphere + texture2D(globeTexture,vUV).xyz, 1.0) ;
     }`,
  uniforms: {
    globeTexture: { value: new TextureLoader().load("./img/Earth.jpeg") }
  }
}));
var atmosphere = new Mesh(new SphereGeometry(5, 50, 50), new ShaderMaterial({
  vertexShader: `
     varying vec3 vNormal;
     void main(){
      vNormal = normalize(normalMatrix * normal);
  ...
  fragmentShader: `
     varying vec3 vNormal;
     void main(){
      float intensity = pow(.8 - dot(vNormal, vec3(-.3,0,1)), 2.0);
      gl_FragColor = vec4(0.4, 0.2, .6 , 1.0) * intensity;
     }`,
...
var starMaterial = new PointsMaterial({
  color: 16777215,
  size: 0.1
});
var starVertices = [];
...
scene.add(stars);
sphereGeometry.rotation.z += -0.23;
